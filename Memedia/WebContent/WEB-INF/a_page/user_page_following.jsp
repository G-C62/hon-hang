	...
	<body>
		<div class="wrap">
			...
			<div class="content">
					...
					<div class="user-intro">
						...
						<div class="intro-txt">
							<div class="name">
								...
								<div class="btn-area">
									<% if(fw.equals("ok")){ %>
									<button class="follow-btn" onclick="location.href='/follow/deleteFollow_fwg.do?id=${id}&a_id=${a_id }'">팔로우 취소</button>									
									<% } else { %>
									<button class="follow-btn" onclick="location.href='/follow/insertFollow_fwg.do?id=${id}&a_id=${a_id }'">팔로우</button>
									<% } %>
								</div>
							</div>
							<div class="desc">
				...
				<div class="user-nav">
					<ul>
						<li><a href="/a_page/user_page_s.do?id=${id }&a_id=${a_id}">여행일정</a></li>
						<li><a href="/a_page/user_page_r.do?id=${id }&a_id=${a_id}">여행후기</a></li>
						<li><a href="/a_page/user_page_fwr.do?id=${id }&a_id=${a_id}">팔로워</a></li>
						<li class="nav-active"><a href="/a_page/user_page_fwg.do?id=${id }&a_id=${a_id}">팔로잉</a></li>
					</ul>
				</div>
				<div class="list">
					<div class="user-list">
						...
						<div class="user">
							...
							<% if(follow.getUser_id().equals(id)){ %>
								<%=follow.getUser_name() %>
							<%} else{ %>
								<a href="/page/user_page_s.do?id=${id }&a_id=<%=follow.getUser_id()%>"><%=follow.getUser_name() %></a>
							<%} %>
							</div>
						</div>
						<%
