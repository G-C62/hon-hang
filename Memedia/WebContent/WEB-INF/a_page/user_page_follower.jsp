			...
			<div class="content">
					...
					<div class="user-intro">
						...
						<div class="intro-txt">
							<div class="name">
								...
								<div class="btn-area">
									<% if(fw.equals("ok")){ %>
									<button class="follow-btn" onclick="location.href='/follow/deleteFollow_fwr.do?id=${id}&a_id=${a_id }'">팔로우 취소</button>
									<% } else { %>
									<button class="follow-btn" onclick="location.href='/follow/insertFollow_fwr.do?id=${id}&a_id=${a_id }'">팔로우</button>
									<% } %>
								</div>
							</div>
							<div class="desc">
				...
				<div class="user-nav">
					<ul>
						...
						<li class="nav-active"><a href="/a_page/user_page_fwr.do?id=${id }&a_id=${a_id}">팔로워</a></li>
