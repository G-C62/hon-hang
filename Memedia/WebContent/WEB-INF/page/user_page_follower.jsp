...
<%
	...
	List<Integer> userNum = (List)request.getAttribute("userNum");
%>
<!doctype html>
<html>
	<head>
			...
			<div class="content">
				...
				<div class="user-nav">
					<ul>
						...
						<li class="nav-active"><a href="/page/user_page_fwr.do?id=${id }">팔로워</a></li>
				...
				<div class="list">
					<div class="user-list">
						...
						<div class="user">
							...
							<div class="btn-area">
							<% if(flag == 0) {%>
								<button class="user-unfollow" onclick="location.href='/follow/deleteFollowPfwr.do?id=${id }&a_id=<%=follow.getUser_id()%>'">팔로잉 취소</button>
							<% } else { %>
								<button class="user-follow" onclick="location.href='/follow/insertFollow.do?id=${id }&a_id=<%=follow.getUser_id()%>'">팔로우</button>
							<% } %>
							</div>
						</div>
						<%
